...
if ('storage' in navigator && 'estimate' in navigator.storage) {
    navigator.storage.estimate().then((estimate) => {
        ...
        console.log(`Used space: ${(usedBytes / (1024 * 1024)).toFixed(2)} MB`);
        console.log(`Total available space: ${(totalBytes / (1024 * 1024)).toFixed(2)} MB`);
        console.log(`Remaining space: ${((totalBytes - usedBytes) / (1024 * 1024)).toFixed(2)} MB`);
    }).catch((error) => {
