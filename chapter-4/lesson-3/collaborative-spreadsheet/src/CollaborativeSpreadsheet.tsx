...
const user1Edits = simulateUserEdit('User1', 2000)
const user2Edits = simulateUserEdit('User2', 3000)

// З допомогою оператора merge змерждимо 3 стріми в один та емітимо cellUpdates
merge(user1Edits, user2Edits, uiEdits).subscribe(update => {
...
const CollaborativeSpreadsheet = () => {
    ...
    useEffect(() => {
        ...
        const subscription = cellUpdates.subscribe(update => {
